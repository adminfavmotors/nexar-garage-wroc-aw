      ...
      <main className="pt-20 lg:pt-24">
        <section className="section-block border-b border-border">
          <div className="site-shell">
            ...
            <h1 className="text-balance measure-hero mt-4 font-barlow text-[34px] font-extrabold uppercase leading-[0.96] text-foreground min-[360px]:text-[38px] sm:text-[58px] lg:text-[74px]">
              {t("USŁUGI NEXAR GARAGE", "NEXAR GARAGE SERVICES")}
            </h1>
            <p className="measure-copy-wide mt-5 font-inter text-[15px] leading-relaxed text-muted-foreground sm:text-[17px]">
              {t(
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              <a
                ...
                className="inline-flex w-full items-center justify-center border border-primary bg-primary px-6 py-3.5 text-center font-barlow text-[13px] font-bold uppercase tracking-[0.16em] text-primary-foreground transition-all duration-300 hover:-translate-y-0.5 hover:bg-primary/90 sm:w-auto sm:px-7 sm:text-[14px]"
              >
        ...
        <section id="uslugi" className="section-block border-b border-border">
          <div className="site-shell">
            ...
            <h2 className="text-balance mx-auto mt-3 text-center font-barlow text-[34px] font-extrabold uppercase text-foreground min-[360px]:text-[38px] sm:text-[48px] sm:leading-[1] lg:text-[56px]">
              ...
              {servicePages.map((service) => (
                ...
                >
                  ...
                  <div className="service-card-divider mt-6 pt-5">
                    ...
                    <p className="mt-2 font-barlow text-[22px] font-bold uppercase tracking-[0.03em] text-accent transition-colors duration-500 group-hover:text-foreground min-[360px]:text-[24px] sm:text-[28px]">
        ...
        <section ref={detailsRef} className="section-block border-b border-border">
          <div className="site-shell">
            ...
            <h2 className="mt-3 font-barlow text-[34px] font-extrabold uppercase text-foreground min-[360px]:text-[38px] sm:text-[48px]">
            ...
            >
              {servicePages.map((service) => (
                ...
                >
                  <AccordionTrigger className="px-5 py-4 text-left font-barlow text-[20px] font-bold uppercase tracking-[0.04em] text-foreground hover:no-underline min-[360px]:px-6 min-[360px]:text-[22px] sm:px-8 sm:py-5 sm:text-[28px]">
                  ...
                  <AccordionContent className="px-5 pb-5 min-[360px]:px-6 min-[360px]:pb-6 sm:px-8 sm:pb-8">
                      ...
                      <div>
                        <div className="grid gap-px bg-border sm:grid-cols-2 lg:grid-cols-1">
                          <div className="service-card-panel p-5">
                            ...
                            <p className="mt-3 font-barlow text-[24px] font-bold uppercase text-accent min-[360px]:text-[28px]">
                              {t(service.price.pl, service.price.en)}
                            </p>
                          </div>
                          <div className="service-card-panel p-5">
                            ...
                            <p className="mt-3 font-barlow text-[24px] font-bold uppercase text-foreground min-[360px]:text-[28px]">
            ...
            {activeService && (
              <div className="service-card mt-8 p-6 sm:p-8">
                ...
                <h3 className="mt-3 font-barlow text-[26px] font-bold uppercase text-foreground min-[360px]:text-[30px] sm:text-[38px]">
